        ...
        if(ProcessLifecycleOwner.get().getLifecycle().getCurrentState().isAtLeast(Lifecycle.State.STARTED)) {
            IronSource.setInterstitialListener(new com.ironsource.mediationsdk.sdk.InterstitialListener() {
                ...
                public void onInterstitialAdLoadFailed(IronSourceError ironSourceError) {
                    Log.e("faildironsrcinter: ", ironSourceError.getErrorMessage() + ironSourceError.getErrorCode());
                }
...
//        layoutParams.addRule(RelativeLayout.ALIGN_PARENT_RIGHT);
    ...
    public static  void show_native(Context context
        ...
        if(ProcessLifecycleOwner.get().getLifecycle().getCurrentState().isAtLeast(Lifecycle.State.STARTED)) {
            ...
            RelativeLayout relativeLayout = activity.findViewById(R.id.native_container);
...
// EDITTEXT
    ...
    public static  void show_native(Context context,View view
        ...
        if(ProcessLifecycleOwner.get().getLifecycle().getCurrentState().isAtLeast(Lifecycle.State.STARTED)) {
            ...
            RelativeLayout relativeLayout = view.findViewById(R.id.native_container);
...
// EDITTEXT
    ...
    public static  void ownnative(Context context,RelativeLayout relativeLayout){
        if(ProcessLifecycleOwner.get().getLifecycle().getCurrentState().isAtLeast(Lifecycle.State.STARTED)) {
            if (config.activate_own_ads.equals("1")) {
                if (relativeLayout.getChildCount() != 0) {
                    relativeLayout.removeAllViews();
...
//            linearLayout.addView(adView);
    ...
    public static void createNativeAd_apploving(Context context, RelativeLayout relativeLayout)
    {
        RelativeLayout nativeAdContainer = relativeLayout;
